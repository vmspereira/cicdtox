...
class TestGPR(unittest.TestCase):
    ...
    def test_aritmetic(self):
        ...
        from exparse.parsing import Arithmetic, build_tree, ArithmeticEvaluator
    ...
    def test_gpr(self):
        """Tests gpr
        """
        from exparse.parsing import Boolean, build_tree, BooleanEvaluator
    ...
    def test_ou(self):
        ...
        """
        from exparse.parsing import GeneEvaluator, Boolean, build_tree
        # Gene OU example
